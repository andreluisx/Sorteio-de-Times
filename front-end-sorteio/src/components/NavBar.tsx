    ...
    <header className="bg-slate-800/80 backdrop-blur-sm  border-b border-slate-700">
      <div className="container mx-auto pl-4 sm:pl-0 pr-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <div onClick={handleLogout}><p>Sair</p></div>
          }
        ...
        <div className="md:hidden bg-slate-800/80 backdrop-blur-sm border-b border-slate-700">
          <nav className="flex flex-col space-y-2 p-4">
              ...
              <div className="cursor-pointer">
                <div className="items-center flex text-slate-100 p-3 mb-3 gap-3 hover:text-slate-300">
                  ...
                  <p className="whitespace-nowrap">
                    Balanceado por Taxa de Vitória
                  </p>
                </div>
              </div>
            </Link>
            ...
            <Link href={'/auth/register'}>
              <div className="px-4 py-2 flex justify-center items-center text-white rounded">
                <p>Registrar</p>
              </div>
            </Link>
            <Link href={'/auth/login'}>
              <div className="px-4 py-2 flex justify-center items-center bg-red-600 text-white rounded hover:bg-red-700 ">
                <p>Entrar</p>
              </div>
            </Link>
          </nav>
